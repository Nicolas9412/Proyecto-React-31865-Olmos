...
const Header = () => {
  ...
  return (
    <header className="d-flex justify-content-lg-center justify-content-between header p-4">
      ...
      <form className="d-none d-lg-flex justify-content-center align-items-center ms-4 form-inline my-2 my-lg-0 buscador">
        <input
          className="form-control me-3 mr-sm-2"
          type="search"
          placeholder="Buscar lo que sea..."
          aria-label="Search"
        />
